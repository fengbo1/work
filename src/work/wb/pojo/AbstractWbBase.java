...
/**
 * AbstractWbBase entity provides the base persistence definition of the WbBase entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractWbBase  implements java.io.Serializable {
    ...
    /** default constructor */
    public AbstractWbBase() {
    }

    
    /** full constructor */
    public AbstractWbBase(String date, String no, String name, Integer yslr, Double yslrTime, Integer yslrCc, Integer yslrHs, Integer yslrZy, Integer yslrZl, Integer lrzc, Double lrzcTime, Integer lrzcCc, Integer lrzcHs, Integer lrzcZl, Integer fzyy, Double fzyyTime, Integer fzyyCc, Integer fzyyHs, Double yslrCcl, Double yslrHsl, Double yslrZyl, Double yslrZll, Double lrzcCcl, Double lrzcHsl, Double fzyyCcl, Double fzyyHsl, Double lrzcZll, Double workYslr, Double workFzyy, Double workLrzc, Double workTime, String remark1, String remark2) {
        this.date = date;
        this.no = no;
        this.name = name;
        this.yslr = yslr;
