...
/**
 * AbstractWbFzyy entity provides the base persistence definition of the WbFzyy entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractWbFzyy  implements java.io.Serializable {
    ...
    /** default constructor */
    public AbstractWbFzyy() {
    }

    
    /** full constructor */
    public AbstractWbFzyy(String corpcode, String corpname, Integer online, Double onlineZb, Double avertime, Integer cl, Double clZb, Double cc, Double ccl, Double hs, Double hsl, Double avevCl, String date, String remark1, String remark2) {
