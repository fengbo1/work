...
/**
 	* A data access object (DAO) providing persistence and search support for WbBase entities.
...
public class WbBaseDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(WbBaseDAO.class);
		//property constants
    ...
    public void save(WbBase transientInstance) {
        log.debug("saving WbBase instance");
        try {
	...
	public void delete(WbBase persistentInstance) {
        log.debug("deleting WbBase instance");
        try {
    ...
    public WbBase findById( java.lang.Integer id) {
        log.debug("getting WbBase instance with id: " + id);
        try {
            WbBase instance = (WbBase) getSession()
                    .get("WbBase", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(WbBase instance) {
        log.debug("finding WbBase instance by example");
        try {
            List results = getSession()
                    .createCriteria("WbBase")
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding WbBase instance with property: " + propertyName
            + ", value: " + value);
      try {
         String queryString = "from WbBase as model where model." 
         						+ propertyName + "= ?";
	...
	public List findAll() {
		log.debug("finding all WbBase instances");
		try {
			String queryString = "from WbBase";
	         Query queryObject = getSession().createQuery(queryString);
			 return queryObject.list();
		} catch (RuntimeException re) {
    ...
    public WbBase merge(WbBase detachedInstance) {
        log.debug("merging WbBase instance");
        try {
            WbBase result = (WbBase) getSession()
    ...
    public void attachDirty(WbBase instance) {
        log.debug("attaching dirty WbBase instance");
        try {
    ...
    public void attachClean(WbBase instance) {
        log.debug("attaching clean WbBase instance");
        try {
