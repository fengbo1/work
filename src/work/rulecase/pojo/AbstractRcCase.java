...
/**
 * AbstractRcCase entity provides the base persistence definition of the RcCase entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractRcCase  implements java.io.Serializable {
    ...
    /** default constructor */
    public AbstractRcCase() {
    }

    
    /** full constructor */
    public AbstractRcCase(String renewdate, String plate, String pool, String part, String factor, String facAName, String facBName, String facCName, String facA, String facB, String facC, String picname, String rule, String exp, String renewexp, String remark) {
