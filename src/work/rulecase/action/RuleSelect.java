...
public class RuleSelect {
	...
	*/
	...
	public String execute() throws Exception{
		...
		else if(!pool.equals("qxz")||(!part.equals("qxz")&&!part.equals(""))||(!area.equals("qxz")&&!area.equals(""))||(!factor.equals("qxz")&&!factor.equals(""))||!word.trim().equals(""))
		{
			hql = "from RcRule as rr where 1=1 and plate='"+plate+"'";
		}
		else
		{
			hql = "from RcRule as rr where 1=0";
...
//		if(key.equals("pool"))
//		{
//			sql="select distinct(part) from t_rc_rule where pool='"+pool+"' and plate='"+plate+"'";
//			if(pool.equals("qxz"))
//			{
//				//hql = "from RcRule as rr where rr.plate='"+plate+"' order by rr.renewdate desc";
//			}
//			else
//			{
//				hql = "from RcRule as rr where rr.plate='"+plate+"' and rr.pool='"+pool+"' order by rr.renewdate desc";
//			}
//		}
//		else if(key.equals("part"))
//		{
//			//part = new String(part.getBytes("ISO8859-1"),"UTF-8");
//			sql="select distinct(factor) from t_rc_rule where pool='"+pool+"' and part='"+part+"' and plate='"+plate+"'";
//			if(part.equals("qxz"))
//			{
//				hql = "from RcRule as rr where rr.plate='"+plate+"' and rr.pool='"+pool+"' order by rr.renewdate desc";
//			}
//			else
//			{
//				hql = "from RcRule as rr where rr.plate='"+plate+"' and rr.pool='"+pool+"' and rr.part='"+part+"' order by rr.renewdate desc";
//			}
//		}
...
//			else
//			{
//				hql = "from RcRule as rr where rr.plate='"+plate+"' and rr.pool='"+pool+"' and rr.part='"+part+"' and rr.factor='"+factor+"' order by rr.renewdate desc";
//			}
//		}
		if(!sql.equals(""))
		...
		//listrc = session.createQuery(hql).list();
		trans.commit();
		session.flush();
		session.clear();
		session.close();
