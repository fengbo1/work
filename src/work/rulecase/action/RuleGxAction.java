...
public class RuleGxAction {
	...
	*/
	...
	private List<RcRuleSearch> list;
	public List<RcRuleSearch> getList() {
		return list;
	}
	public void setList(List<RcRuleSearch> list) {
		this.list = list;
	}
	...
	public String execute() throws Exception{
		...
		hql = "from RcRule as rr where rr.renewdate>='"+lastmonthdate+"' order by rr.renewdate desc";
