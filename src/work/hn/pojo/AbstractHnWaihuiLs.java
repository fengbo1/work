...
/**
 * AbstractHnWaihuiLs entity provides the base persistence definition of the HnWaihuiLs entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractHnWaihuiLs  implements java.io.Serializable {
    ...
    /** default constructor */
    public AbstractHnWaihuiLs() {
    }

    
    /** full constructor */
    public AbstractHnWaihuiLs(String date, String no, String name, Integer zx, Integer xz, Integer zycs, Integer zyfs, Integer lrxg, Integer lrsq, Integer jhxg, Integer jhsq, Integer pjcs, Integer pjfs, Integer sbyy, Integer hrcs, Integer hrfs, Double xlzycs, Double xlzyfs, Double xllrxg, Double xllrsq, Double xljhxg, Double xljhsq, Double xlpjcs, Double xlpjfs, Double xlsbyy, Double xlhrcs, Double xlhrfs, Integer lrcc, Double lclv, Integer jhcc, Double jclv, Integer tp, Double tplv, Integer cx, Double cxlv, Double zhcl, Integer ywl, Double sumxl, Double ccl, Double percl, Integer bh, Double bhl) {
        this.date = date;
        this.no = no;
        this.name = name;
        this.zx = zx;
