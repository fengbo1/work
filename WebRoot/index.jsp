...
//if(IP.startsWith("52.242")||IP.startsWith("64.244.184")||IP.startsWith("64.244.176")||IP.startsWith("64.244.178")||IP.equals("127.0.0.1")||IP.startsWith("192.168.1"))
if(1==1)
{
...
<div><b class="b1"></b><b class="b2 d1"></b><b class="b3 d1"></b><b class="b4 d1"></b>
		   		<div class="b d1 k">
		   		<div style="width: 308px; font-family: '宋体'; text-align: center; font-size: 24px; margin-top: 10px;">生产信息管理工具</div>
