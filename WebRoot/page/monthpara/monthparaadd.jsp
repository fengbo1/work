...
<body>
	<div class="layout">
		<form name="form" id="form" method="post" action="monthparaadd.action" onsubmit="return validateForm()">
			<div class="title">参数增加</div>
			<div id="content" >
				...
				<div class="four_columns">	
					...
					<div class="four_columns_input">
						 <input type="text" id="hnCl" name="hnCl"/>
					</div>
					<div class="four_columns_text">行内人员当月质量目标值</div>
					<div class="four_columns_input">
						 <input type="text" id="hnZl" name="hnZl"/>
					</div>
				<div class="clear"></div>
				</div>
				<div class="four_columns">	
					...
					<div class="four_columns_input">
						<input type="text" id="wbCl" name="wbCl"/>
					</div>
					<div class="four_columns_text">外包人员当月质量目标值</div>
					<div class="four_columns_input">
						  <input type="text" id="TBz" name="TBz"/>
					</div>
				<div class="clear"></div>
				</div>
					<div class="four_columns">
