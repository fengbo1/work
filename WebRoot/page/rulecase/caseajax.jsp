...
<table  align="center" style="border: 0px; " cellpadding="0" cellspacing="2" >
				<c:forEach items="${listrc}" var="rule" varStatus="status">
					<tr <c:if test="${status.count%2==0}">class="odd"</c:if> 
						...
						<td height="25" width="55px" align="center" valign="middle">
							<div align="center">
								${rule.pool}
							</div>
						</td>
						...
						<td height="25" width="200px" align="center" valign="middle">
							<div align="center">
								<c:if test="${rule.picname!=''}">
									<img style="width:190px;height:60px" src="${imagepath}${rule.picname}">
								</c:if>	
							</div>
						</td>
						<td height="25" width="200px" align="left" valign="middle">
						...
						<td height="25" width="165px" align="center" valign="middle" nowrap>
							<div align="center">
							<c:if test="${mg!=1}">	
				...
				<table width="1080px" height="40" align="center" cellpadding="0"
						cellspacing="2" >
				<tr class="表格表头背景">
							<td colspan="3">
								<div align="center">
...
<c:if test="${key=='pool'}">
	环节
<select id="part" name="part" style="width: 120px" onchange="setkey('part');change('1')">
...
<c:if test="${key=='part'}">
	要素
<select id="factor" name="factor" style="width: 120px" onchange="setkey('factor');change('1')">
 	<option value="qxz">请选择</option>
 <c:forEach items="${list}" var="rule" varStatus="status">
 	<option value="${rule}">${rule}</option>
 </c:forEach>
