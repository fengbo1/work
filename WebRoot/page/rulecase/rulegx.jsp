...
<script type="text/javascript">
 ...
 function view(idd)
	{
		window.open("<%=path%>/rulejumptodetail.action?id="+idd,"","height=700,width=950,top=100,left=290,scrollbars=yes,resizable=yes");
		window.close();
	}
 </script>
			...
			<div id="scroll" align="center" style="overflow-y: scroll; overflow-x: hidden;height:460px">
				...
				<table width="850px" height="40" align="center" cellpadding="0"
						...
						<tr class="表格表头背景">
							<td colspan="3">
								<div align="center">
								<a	href="<%=path%>/rcrulegx.action?currentPage=${previousPage}"
							style="padding-right: 30px;color: #104E8B">上一页</a> 
									${currentPage} of ${totalPages}
								<a	href="<%=path%>/rcrulegx.action?currentPage=${nextPage}"
