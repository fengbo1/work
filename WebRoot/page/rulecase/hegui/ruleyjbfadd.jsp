...
<html>
	...
	<body>
		<form name="filename" action="ruleyjbfadd.action" method="post" enctype="multipart/form-data">
			<div class="layout" >
				...
				<div class="four_columns">
					...
					<div class="four_columns_input">
						<input type="text" name="fac_b" value=""/>
					</div>
					<div class="clear"></div>
				</div>
				<div class="four_columns">
					...
					<div class="four_columns_input">
						<input type="text" name="fac_c" value=""/>
					</div>
					<div class="clear"></div>
				</div>
