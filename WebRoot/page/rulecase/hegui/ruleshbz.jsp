...
highlight(); 
	...
	function viewdetail(idd)
	{
		window.open("<%=path%>/rulehgdetail.action?id="+idd+"&pool=2","","height=700,width=950,top=100,left=290,scrollbars=yes,resizable=yes");
		window.close();
	}
	...
	function xinzeng()
	{
		...
		window.open("<%=path%>/page/rulecase/hegui/ruleshbzadd.jsp","","height=700,width=950,top=100,left=290,scrollbars=yes,resizable=yes");
	}
	function importhg()
	{
	...
	function mngop()
	{
		window.open("<%=path%>/rulehgmngop.action","","height=700,width=950,top=100,left=290,scrollbars=yes,resizable=yes");
	}
	function highlight()
	 {
			...
			<div id="btm" align="center" style="height:40px">
				...
				<tr class="表格表头背景">
							...
							<td colspan="3">
								...
								<c:if test="${zhi=='2'||zhi=='1'}">
								<input type="button" value="配置维护操作岗" onclick="mngop();">
								</c:if>
								</div>
							</td>	
						</tr>
