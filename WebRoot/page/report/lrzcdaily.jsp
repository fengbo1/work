...
$("tr.btbj:even").css({"background-color":"#bfd3fc","font-family": "黑体","font-size": "14px","font-weight":"lighter" }); 
 ...
 <link href="<%=path%>/css/table_back.css" rel="stylesheet" type="text/css">
  ...
  <body>
	<form action="<%=path%>/lrzcdaily.action" method="post" name="fm1">
  <table align="center" style="" border="0px">
 						<tr style="height:50px">
							<td
								style="color: #1778C2; padding-top: 15px; padding-bottom: 15px; border: 0px; font-size: 26px; font-family: '黑体';"
								colspan="10" align="center" bordercolor="#FFFFFF"><b>${date.replace("-","")}录入仲裁日报</b>
							</td>
						</tr>
						...
						<tr height="50px" class="表格表头背景1" id="hang">
							...
							<td  width="85px" align="center" valign="middle" 
								bordercolor=none><div align="center">
									<p>人均切片量</p>
								</div></td>		
						 ...
						 <c:forEach items="${list}" var="wb" varStatus="status">
							 <tr  <c:if test="${status.count%2==0}">class="c_ghbs1"</c:if> 
								...
								<td  width="50px" height="30" align="center" valign="middle" ><div
										align="center">${status.index+1}</div></td>
								<td width="140px" height="25" align="center" valign="middle" ><div 
										align="center">${wb.corpname}</div></td>
								<td width="70px" height="25" align="center" valign="middle" ><div
										align="center">${wb.online}</div></td>
								<td width="65px" height="25" align="center" valign="middle" ><div
								...
								<td width="85px" height="25" align="center" valign="middle" ><div
