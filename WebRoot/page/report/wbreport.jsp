...
$("tr.btbj:even").css({"background-color":"#bfd3fc","font-family": "黑体","font-size": "14px","font-weight":"lighter" }); 
 ...
 <link href="<%=path%>/css/table_back.css" rel="stylesheet" type="text/css">
  ...
  <body>
	<form action="<%=path%>/wbdaily.action" method="post" name="fm1">
  <table align="center"  border="0px" >
  	
						<tr>
							<td
								style="color: #1778C2; padding-top: 15px; padding-bottom: 15px; border: 0px; font-size: 26px; font-family: '黑体';"
								colspan="22" align="center" bordercolor="#FFFFFF"><b>${date.replace("-","")}要素录入日报</b>
							</td>
						</tr>
						<tr height="20px">
							<td colspan="12" align="center">
							<div class="ddd" align="left">日期 &nbsp;&nbsp;</div>
							<div class="ddd" align="left" style="width:50px">
						...
						<tr  class="表格表头背景1" id="hang">
							...
							<td  width="61px" align="center" valign="middle" nowrap
								bordercolor=none><div align="center">
									<p>工作量</p>
								</div></td>	
							...
							<td  width="150px" align="center" valign="middle" nowrap
							 ...
							 <tr <c:if test="${status.count%2==0}">class="c_ghbs1"</c:if> 
							      <c:if test="${status.count%2!=0}">class="c_ghbs2"</c:if> style="height:30px">
								<td  width="49px" height="30" align="center" valign="middle" nowrap><div
								...
								<td width="60px" height="25" align="center" valign="middle" nowrap><div
										align="center">${fb:doubletopercent(wb.ccl)}</div></td>
								<td width="60px" height="25" align="center" valign="middle" nowrap><div
										align="center">${fb:doubletopercent(wb.hsl)}</div></td>
								...
								<td width="100px" height="25" align="center" valign="middle" nowrap><div
										align="center">${fb:doubledoubletolv(wb.online,wb.aboveZb)}</div></td>
								<td width="150px" height="25" align="center" valign="middle" nowrap><div
										align="center">${fb:doubledoubletolv(wb.online,wb.aboveTimezb)}</div></td>
