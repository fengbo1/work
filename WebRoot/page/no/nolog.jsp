  ...
  <table align="center" style="width:200px" >
						<tr>
							<td
								...
								colspan="22" align="center" bordercolor="#FFFFFF"><b>员工信息维护情况表</b>
							</td>
						</tr>
						<tr height="50px" class="表格表头背景1" id="hang">
							...
							<td  width="200px" align="center" valign="middle" nowrap
							 ...
							 <tr class="btbj" id="hang" style="height:20px">
								...
								<td height="25" align="center" valign="middle" nowrap><div
										align="center">${para.name}</div></td>
								<td height="25" align="center" valign="middle" nowrap><div
										align="center">${para.no}</div></td>
								<td height="25" align="center" valign="middle" nowrap><div
							...
							<td colspan="9">
								<div align="center">
							<a	href="<%=path%>/nolog.action?type=find_all_desc&ccurrentPage=${previousPage}"
							style="padding-right: 30px;color: #104E8B">上一页</a> 
									${currentPage} of ${totalPages}
							<a	href="<%=path%>/nolog.action?type=find_all_desc&currentPage=${nextPage}"
